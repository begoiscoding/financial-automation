...
Description: Calculates the lowest fixed monthly payment needed to pay off 
             a debt within 12 months, rounded up to the nearest $10.
"""
...
test_balance = 7500
test_rate = 0.249 #24.9% in decimals
